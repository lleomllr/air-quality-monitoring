...
public class OzoneAVG {
    public static Topology buildTopology() {
        ...
        Duration advanceSize = Duration.ofMinutes(15);
        ...
        avgAQIByCity.toStream()
                ...
                .to("avg-city-hour", Produced.with(Serdes.String(), avroSerdeAvgCity));
        ...
        avgAQIByState.toStream()
                ...
                .to("avg-state-hour", Produced.with(Serdes.String(), avroSerdeAvgState));
    ...
    public static void main(String args[]) {
        ...
        KafkaStreams streams = new KafkaStreams(OzoneAVG.buildTopology(), props);
        streams.start();
