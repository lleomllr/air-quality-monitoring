...
public class OzoneAVG8Hour {
    public static Topology buildTopology() {
        ...
        KStream<String, PreProcessedSchema> stream = builder.stream("pre-processed-ozone", Consumed.with(Serdes.String(), avroSerdePreProcessed));

        //Définition de la fenêtre glissante --> 8 heure toutes les 2 heures
        Duration windowSize = Duration.ofHours(8);
        Duration advanceSize = Duration.ofHours(2);
        ...
        avgAQIByCity.toStream()
                ...
                .to("avg-city-8-hour", Produced.with(Serdes.String(), avroSerdeAvgCity));
        ...
        avgAQIByState.toStream()
                ...
                .to("avg-state-8-hour", Produced.with(Serdes.String(), avroSerdeAvgState));
    ...
    public static void main(String args[]) {
        ...
        props.setProperty(StreamsConfig.APPLICATION_ID_CONFIG, "ozone-avg-app");
        ...
        KafkaStreams streams = new KafkaStreams(OzoneAVG8Hour.buildTopology(), props);
        streams.start();
