...
public class PM10AVG8Hour {
    ...
    public static void main(String args[]) {
        ...
        props.setProperty(StreamsConfig.APPLICATION_ID_CONFIG, "pm10-avg-app");
        ...
        KafkaStreams streams = new KafkaStreams(PM10AVG8Hour.buildTopology(), props);
        streams.start();
