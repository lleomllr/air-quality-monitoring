...
public class PM25MAX {
    ...
    public static void main(String args[]) {
        ...
        props.setProperty(StreamsConfig.APPLICATION_ID_CONFIG, "pm25-max-app");
        ...
        KafkaStreams streams = new KafkaStreams(PM25MAX.buildTopology(props.getProperty("schema.registry.url")), props);
        streams.start();
