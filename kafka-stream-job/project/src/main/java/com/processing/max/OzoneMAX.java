...
public class OzoneMAX {
    ...
    public static Topology buildTopology(String schemaRegistryUrl) {
        ...
        //Définition de la fenêtre glissante --> 1 par heure
    ...
    public static void main(String args[]) {
        ...
        props.setProperty(StreamsConfig.APPLICATION_ID_CONFIG, "ozone-max-app");
        ...
        KafkaStreams streams = new KafkaStreams(OzoneMAX.buildTopology(props.getProperty("schema.registry.url")), props);
        streams.start();
